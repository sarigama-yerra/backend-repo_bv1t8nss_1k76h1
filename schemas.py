...
# SaaS Landing Page specific schemas
...
class BlogPost(BaseModel):
    ...
    excerpt: str = Field(..., description="Short summary shown on cards")
    content: str = Field(..., description="Full content (markdown or text)")
